  <header class="main-header">
    ...
    <a href="{{'/admin/dashboard'}}" class="logo">
      ...
      <span class="logo-lg"><b>Trip</b>Orbitz</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{'triporbitz/public/images/'.Auth::guard('admin')->user()->image}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{ Session::get('full_name') }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{'triporbitz/public/images/'.Auth::guard('admin')->user()->image}}" class="img-circle" alt="User Image">
