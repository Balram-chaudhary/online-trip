...
<form  enctype="multipart/form-data" class="form-horizontal barter" action="{{route('hotels.propertydetail')}}" method="post">
{{csrf_field()}}
...
<div class="form-group">
    ...
    <div class=" col-sm-offset-0 col-sm-5">
      <select name="basecurrency" class="form-control" tabindex="1" required="required">
            <option value="n" selected="selected">Nepalese rupee</option>  
        </select>
    </div>
  ...
  <div class="form-group">
    ...
    <div class=" col-sm-offset-0 col-sm-5"> 
       <input type="number" class="form-control" name="nrooms"  placeholder=" " tabindex="1" required="required">
    </div>
...
<div class="form-group">
    ...
    <div class=" col-sm-offset-0 col-sm-5">
      <input type="text" class="form-control" name="baseprice"  placeholder="Enter Base price of hotel" tabindex="1" required="required">
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-0 col-sm-5">
    	<input type="text"  name="checkin" required="required" class="form-control">
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-0 col-sm-5">
    	<input type="text" name="checkout" required="required" class="form-control">
    </div>
...
<h3>Location Maps</h3>
<p>You must click search the map to find hotel location, Right click on correction spot to fix location.</p><br>
...
<div>
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57145.51608899802!2d87.23764357599812!3d26.46878864702665!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ef744704331cc5%3A0x6d9a85e45c54b3fc!2sBiratnagar+56613!5e0!3m2!1sen!2snp!4v1526370963086" width="100%" height="440" frameborder="0" style="border:0" allowfullscreen> 
  </iframe>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-0 col-sm-5">
    	<input type="text"  name="price" required="required" class="form-control" placeholder="Enter only price Eg:2000.">
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-0 col-sm-5">
    	<input type="text"  name="noofrooms" required="required" class="form-control" placeholder="Enter Number of Rooms.">
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-0 col-sm-5">
    	<input type="text"  name="childrens" required="required" class="form-control" placeholder="Enter Maximum number of childrens .">
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-offset-0 col-sm-5">
    	<input type="text"  name="adults" required="required" class="form-control" placeholder="Enter Maximum Number of Adults.">
    </div>
...
<div class="form-group"> 
<input type="file" id="image" name="rimage[]"  multiple="multiple">
...
<div class="form-group"> 
<input type="file" id="image1" name="image1[]"  multiple="multiple">
	<!-- <button id="imagebutton" ><i class="fa fa-plus"></i></button> -->
...
$('#continue5').click(function (e) {
    var count5=0;
   var fields =document.getElementById('image').value;
   //alert(fields);
 var $active = $('.nav-tabs li.active');
