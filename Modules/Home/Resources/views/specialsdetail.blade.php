      ...
      <div class="container polaroid-box">
        <div class="row">
          <div class="col-md-9 col-sm-8 col-xs-12">
            <h3>{{$specials->aname}}</h3>
             <h4>{{$specials->area}},{{$specials->city}},{{$specials->country}}</h4>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="container">
              <div class="room-selector">
                <h4 class="">Rs&nbsp;{{$specials->price}}</h4><br>
          ...
          <div class="col-md-8 col-sm-8 col-xs-8">
            ...
            <div class="tab-content" style="width:100%;height:500px;">
              <div id="photos" class="tab-pane fade in active">
                <div class="row">
                  <div class="col-md-3">
                    <a href="{{url('triporbitz/public/images/'.$specials->image)}}" class="example-image-link" data-lightbox="Vacation">
                      <img class="example-image" src="{{url('triporbitz/public/images/'.$specials->image)}}">
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div col-md-4 col-sm-4 col-xs-4>
          ...
          <h2>Duration:</h2>{{$specials->hour}}Hour&nbsp;{{$specials->minute}}Minute<br>
          <h2>Highlights</h2>
          <p>{{$specials->add_info}}</p><br>
          <h2>Meeting Point</h2>
          <p>{{$specials->area}},{{$specials->city}}</p>
          <h2>Meeting Time:</h2>
            <p> 8:00Am</p>  
          </div>
