			...
			<div class="container polaroid-box">
				<div class="row">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<h3>{{$hotel->hname}}</h3>
						<small>{{$hotel->area}}&nbsp;,{{$hotel->city}}&nbsp;,{{$hotel->country}}</small>
					</div>
               ...
               <!-- ................policies...................... -->
				...
				<!-- ..........end of policies.............. -->
                            ...
                            <div class="col-md-3 chekinout">
								<label>Chekin :</label>{{$hotel->checkin}}  pm<br>
								<label>Chekout :</label>{{$hotel->checkout}} pm
				          </div>
				</div>
		</div>
      </div>
	...
	<div class="row col-sm-12 roomsrow">
	          ...
	          <div class="col-sm-2 form-left-agileits-w3layouts editContent">
					...
					<div class="agileits_w3layouts_main_gridl">
						<input class="date has Datepicker btn-height" id="datepicker" name="checkin" type="text" value="{{$checkin}}" required="">
					</div>
				</div>
				...
				<div class="col-sm-2 form-left-agileits-w3layouts editContent">
					...
					<div class="agileits_w3layouts_main_gridl">
						<input class="date has Datepicker btn-height" id="datepicker1" name="checkout" type="text" value="{{$checkout}}"  required="">
					</div>
				</div>
				...
				<div class="col-sm-2 form-left-agileits-w3layouts editContent">
					...
					<div class="agileits_w3layouts_main_gridl">
						<input  name="adults" type="number" value="{{$adults}}" required="" id="totaladult" min="1">
					</div>
				</div>
	             ...
	             <div class="col-sm-2 form-left-agileits-w3layouts editContent">
					...
					<div class="agileits_w3layouts_main_gridl">
						<input  name="childs" type="number" value="{{$childs}}"  required="" id="totalchild" min="0">
					</div>
				</div>
				 ...
				 <div class="col-sm-2 form-left-agileits-w3layouts editContent" >
					...
					<div class="agileits_w3layouts_main_gridl">
						<input  name="rooms" type="number" value="{{$roomstotal}}"  required="" id="totalroom" min="1">
					</div>
				</div>
  ...
  <table class="col-sm-12 Tableborder">
    ...
    <tbody id="avaialablerooms">
     ...
     <td>
		  ...
		  <button class="btn btn-primary btn-block bookroom" type="button" data-toggle="modal" data-target="#paymentmodel" id="bookroom">Book Room</button>
		</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="paymentoption">
          <div id="paymentheader"><h3>Select your payment option</h3></div>
			<div class="col-md-12 payselector">
				<div class="row">
					<div class="col-md-6">
						<a href="{{route('hotels.review')}}" class="btn btn-primary" type="button" value="Pay Now">Pay Now</a>
						<ul id="paynow">
					...
					<div class="col-md-6">
						<a href="{{route('hotels.review')}}" class="btn btn-primary" type="button" value="Pay at property">Pay at property</a>
						<ul id="payatproperty">
